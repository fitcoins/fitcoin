...
static const char *strMainNetDNSSeed[][2] = {
    {"ny.fitcoins.net", "ny.fitcoins.net"}, 
    {"la.fitcoins.net", "la.fitcoins.net"}, 
    {"eu.fitcoins.net", "eu.fitcoins.net"},
    {"oc.fitcoins.net", "oc.fitcoins.net"},
    {"sa.fitcoins.net", "sa.fitcoins.net"},
    {"as.fitcoins.net", "as.fitcoins.net"},
    {NULL, NULL},
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet-seed.fitcoins.net", "testnet-seed.fitcoins.net"},
    {NULL, NULL},
};
